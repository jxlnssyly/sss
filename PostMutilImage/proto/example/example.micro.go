...
/*
Package go_micro_srv_PostMutilImage is a generated protocol buffer package.
...
type ExampleService interface {
	PostMutilImage(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func NewExampleService(name string, c client.Client) ExampleService {
	...
	if len(name) == 0 {
		name = "go.micro.srv.PostMutilImage"
	}
...
func (c *exampleService) PostMutilImage(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.PostMutilImage", in)
	out := new(Response)
...
type ExampleHandler interface {
	PostMutilImage(context.Context, *Request, *Response) error
...
func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		PostMutilImage(ctx context.Context, in *Request, out *Response) error
...
func (h *exampleHandler) PostMutilImage(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.PostMutilImage(ctx, in, out)
}
