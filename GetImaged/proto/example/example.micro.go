...
/*
Package go_micro_srv_GetImaged is a generated protocol buffer package.
...
type ExampleService interface {
	GetImaged(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func (c *exampleService) GetImaged(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.GetImaged", in)
	out := new(Response)
...
type ExampleHandler interface {
	GetImaged(context.Context, *Request, *Response) error
...
func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		GetImaged(ctx context.Context, in *Request, out *Response) error
...
func (h *exampleHandler) GetImaged(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.GetImaged(ctx, in, out)
}
